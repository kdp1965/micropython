...
#define SIM_SRAM_SPI_CS   21
#define SIM_SRAM_SPI_MOSI 22  // Must be CS + 1
#define SIM_SRAM_SPI_MISO 23  // Must be CS + 2
#define SIM_SRAM_SPI_SCK  24
